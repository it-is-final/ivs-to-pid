...
export function recoverPokemonOriginSeedsFromIvs(
  ...
  const ivSeedsMethod12 = recoverIvSeed(hp, attack, defense, specialAttack, specialDefense, speed, false);
  const ivSeedsMethod4 = recoverIvSeed(hp, attack, defense, specialAttack, specialDefense, speed, true);
